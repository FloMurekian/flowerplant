...
export default function Create({ flowers, setFlowers }) {
    ...
    return (
        <form style={{ maxWidth: "600px", margin: "0 auto", fontFamily: "Epilogue, sans-serif" }} onSubmit={createHandler}>
           ...
           <label style={{ fontSize: "18px", fontWeight: "250"}} htmlFor="level">Level</label>
            ...
            <br />
            <button style={{ backgroundColor: "green", color: "white", padding: "12px 20px", border: "none", borderRadius: "4px", cursor: "pointer", fontFamily: "Epilogue, sans-serif",fontSize: "16px", display: "block", margin: "20px auto" }} type="submit">Plant</button>
        </form>
